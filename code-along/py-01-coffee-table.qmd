...
gt_tbl_2 = (
    gt_tbl_1
    .tab_header(title = 'Coffe Equipment Sales'
)
...
gt_tbl_3 = (
    gt_tbl_2
    .tab_spanner(label = 'Revenue', columns = sc.starts_with("revenue"))
    .tab_spanner(label = 'Profit', columns = sc.starts_with("profit"))
)
...
gt_tbl_9 = (
    ...
    .tab_style(
        ...
        locations = loc.body(rows = pl.col("product") == "Total") # where product is the same as total
)
